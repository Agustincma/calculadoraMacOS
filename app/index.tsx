...
const CalculaterApp = () => {
  ...
  const {formula, prevNumber, buildNumber, clean, toggleSign, deleteLast, divideOperation, addOperation, subtractOperation, multiplyOperation, calculateSubResult, calculateResult} = useCalculator()
  ...
  return (
    <View style={globalStyles.calculatorContainer}>
      ...
      <View style={globalStyles.row}>
        <CalculatorButton label="C" textBlack color={Colors.lightGray} onPress={clean}/>
        <CalculatorButton label="+/-" textBlack color={Colors.lightGray} onPress={toggleSign}/>
        <CalculatorButton label="del" textBlack color={Colors.lightGray} onPress={deleteLast}/>
